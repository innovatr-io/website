  ...
  <ImagesSlider className="h-[66vh] w-full" images={images}>
   ...
   >
    ...
    <div className="flex gap-4">
      <button className="px-4 py-2 backdrop-blur-sm border border-cosmos-accent/20 text-white mx-auto text-center rounded-lg relative mt-4 hover:bg-emerald-500/10 transition-all duration-300 shadow-md hover:shadow-xl">
        <span>Explore Now →</span>
      </button>
      <button className="px-4 py-2 backdrop-blur-sm border border-cosmos-accent/20 text-white mx-auto text-center rounded-lg relative mt-4 hover:bg-[#5EE2E7]/10 transition-all duration-300 shadow-md hover:shadow-xl">
