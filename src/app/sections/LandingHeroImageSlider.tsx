  ...
  <ImagesSlider className="h-[66vh] w-full" images={images}>
   ...
   >
    ...
    <div className="flex gap-4">
      <button className="px-4 py-2 backdrop-blur-sm border border-emerald-500 text-white mx-auto text-center rounded-lg relative mt-4 hover:bg-emerald-500/10 transition-all duration-200">
        <span>Explore Now →</span>
      </button>
      <button className="px-4 py-2 backdrop-blur-sm border border-[#5EE2E7] text-white mx-auto text-center rounded-lg relative mt-4 hover:bg-[#5EE2E7]/10 transition-all duration-200">
