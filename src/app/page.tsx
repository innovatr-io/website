      ...
      <section className="w-full max-w-6xl mx-auto py-16 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <h4 className="text-lg font-medium mb-4 text-gray-400">Democratizing Investment</h4>
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <h4 className="text-lg font-medium mb-4 text-gray-400">Collective Intelligence</h4>
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <h4 className="text-lg font-medium mb-4 text-gray-400">Secure and Transparent</h4>
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <h4 className="text-lg font-medium mb-4 text-gray-400">Expand Your Horizons</h4>
