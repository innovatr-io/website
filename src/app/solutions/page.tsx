 ...
 return (
  <Layout>
   <GradientBanner className="h-[400px] mb-16">
    ...
    >
     In today&apos;s world, ownership of high-value assets and intellectual
     property is largely inaccessible to the broader market. Whether it&apos;s
     music royalties, fine art, real estate, or creative intellectual property,
     the gatekeepers have traditionally been large corporations and a small
     group of well-capitalized investors. Innovatr is here to change that.
    </motion.p>
   </GradientBanner>
