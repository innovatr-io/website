...
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex flex-col min-h-screen bg-cosmos-background text-cosmos-text-light">
      ...
      <nav className="navbar bg-cosmos-primary/70 text-cosmos-text-light backdrop-blur-md fixed top-0 left-0 right-0 z-50 border-b-4 border-gradient-to-r from-cosmos-primary via-cosmos-secondary to-cosmos-accent">
